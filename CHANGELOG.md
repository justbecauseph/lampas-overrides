...
### Added / Changed
- feat: make Lampia cheese always edible, add fire-res/strength to rush, soften withdrawal

## [v1.0.81] - 2026-06-28

### Added / Changed
- feat: add euphoric "rush" to Lampia cheese so it's enticing
...
### Added / Changed
- Merge branch 'master' into feature/lampia
- feat: new sprites
- changes
- feat: Lampia cheese — addictive artificial cheese items + withdrawal

## [v1.0.73] - 2026-06-25

### Added / Changed
- feat: echo global chat to a Discord webhook
